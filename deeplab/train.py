...
flags.DEFINE_string('train_logdir', 'checkpoints',
...
flags.DEFINE_string('dataset_dir', '/content/gdrive/My Drive/models-master/research/deeplab/datasets/Custom_Dataset/tfrecord', 'Where the dataset reside.')
