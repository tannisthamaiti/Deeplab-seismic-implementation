...
Image folder:
  ./Custom_Dataset/Seismic/JPEGImages

Semantic segmentation annotations:
  ./Custom_Dataset/Seismic/SegmentationClass

list folder:
  ./Custom_Dataset/Seismic/ImageSets/Segmentation
...
tf.compat.v1.flags.DEFINE_string('image_folder',
                           './CustomDataset/JPEGImages',
                           'Folder containing images.')
tf.app.flags.DEFINE_string(
    'semantic_segmentation_folder',
    './CustomDataset/SegmentationClass',
    'Folder containing semantic segmentation annotations.')
tf.app.flags.DEFINE_string(
    'list_folder',
    './CustomDataset/ImageSets',
